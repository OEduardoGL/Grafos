...
int main()  
{
    ...
    Graph g(V); //  Chamada de função para criar o objeto Grafo
	...
	for(int i = 0; i < qtd_arest; i++)
	{
    	...
    	g.addEdge(vert_1, vert_2, peso);
   	}
    g.shortestPathingraph(1); // Chamada de Função para encontrar o menor caminho, tendo '1' como o vértice inicial
